...
* **disablePayloadLogs** (boolean) If provided and set `true`, suppresses `payload` from error messages and logs. If `preProcessorARN` is provided, this also suppresses the output payload of the pre-processor.
