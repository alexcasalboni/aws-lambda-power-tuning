...
* **stateMachineNamePrefix** (string, default=`powerTuningStateMachine`) Allows you to customize the name of the statemachine. The last portion of the `AWS::StackId` will be appended to this value: `powerTuningStateMachine-89549da0-a4f9-11ee-844d-12a2895ed91f` (The `StateMachineName` has a maximum of 80 characters and 36 from the `StackId` are appended, allowing 44 for a custom prefix.)
