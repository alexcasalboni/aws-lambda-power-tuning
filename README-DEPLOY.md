...
|            **lmiExecutionTimeout**<br>type: _number_<br>default: `900`              | The timeout in seconds applied to LMI functions (setup, executor), which may take longer due to capacity provider provisioning. Min 60, max 900.                                                                                                                                                                                                                                                                               |
